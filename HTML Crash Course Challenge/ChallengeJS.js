 ...
 */
function clearAll() {
    const memeContentCont = document.querySelector(".meme-content");
    memeContentCont.innerHTML = "";

    const jokeContentCont = document.querySelector(".joke-content");
    jokeContentCont.innerHTML = "";

    const quoteContentCont = document.querySelector(".quote-content");
    quoteContentCont.innerHTML = "";

    const riddleContentCont = document.querySelector(".riddle-content");
    riddleContentCont.innerHTML = "";
}
/**
 * TODO:
...
function showMeme() {
    ...
    newElement.src = randomMemeUrl;
    newElement.alt = "random Meme";
...
function showJoke() {
    ...
    newJokeText.className = "specialtext";
    newJokeText.textContent = randomJokeText;
    container.appendChild(newJokeText);
}
...
function showQuote() {
    ...
    newQuote.textContent = "Quote: " + randomQuote.quote + " , Author: " + randomQuote.author;
...
function revealAnswers() {
    ...
    if (riddle && answer.hidden) {
        ...
        alert("Please select a riddle to preview first");
    }
}
